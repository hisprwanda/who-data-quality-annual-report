...
import { CompletenessOfReport } from '../../components/annual-report/report-preview/completenessofreport/CompletenessOfReport'
// End of imports
...
const Report = function () {
    ...
    if(data) {
        ...
        _settings = settings.setting
        elements = Array.from(new Set(settings.elements))
        configuredDataSet = Array.from(new Set(settings.dataset))
    }
    ...
    // useEffect(() => {
    //     dispatch({
    //         type: Actions.changeOrgUnitLevel,
    //         payload: { level: orgUnitLevelNum },
    //     })
    // }, [orgUnitLevelNum])
    ...
    const setSelectedDataSet = function (selectedGroup, groupCode) {
        dispatch({
            type: Actions.changeDataset,
            payload: { group: selectedGroup, groupCode },
        })
    }
    ...
    const getPeriodsFromSelectedPeriodAndPrecedingYear = (
        date,
        precedingYear
    ) => {
        let _yearSection = date?.length > 4 ? date.substring(0, 4) : date
        const _monthSection =
            date?.length > 4 ? date.substring(4, date.length) : ''
    ...
    const generateReport = () => {
        ...
        const configurationForAnalytics = getConfigObjectsForAnalytics(
            data.results,
            groupCode
        )
        // Variable for the preceding year for reference
        const _precedingYearForReference =
            storeStateSelector.selectedValue.precedingYearForReference
        ...
        const _periods = getPeriodsFromSelectedPeriodAndPrecedingYear(
            _selectedPeriod,
            _precedingYearForReference
        )
        ...
        const _dataElements = Object.keys(
            configurationForAnalytics.dataElementsAndIndicators
        )
    ...
    return (
        <div className="reportContainer">
                ...
                >
                    <div>
                        <SelectorBarItem
                            ...
                            setOpen={() =>
                                _setDataGroupVisibility((prev) => !prev)
                            }
                        >
                            <div
                    ...
                    <div>
                        <SelectorBarItem
                            ...
                            setOpen={() =>
                                _setOrgUnitVisibility((prev) => !prev)
                            }
                        >
                            <div
                            ...
                            <div className="level-and-group">
                                <div className="level">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            display: orgUnitGroupVisibility,
                                        }}
                                    >
                                        <ul>
                                ...
                                <div className="group">
                                    ...
                                    <div
                                        ...
                                        style={{
                                            display: orgUnitLevelVisibility,
                                        }}
                                    >
                                        <ul>
                            ...
                            <div className="update-or-close">
                                <div>
                                    <span>Selected: </span>
                                    {selectedElementStore.orgUnitSet.length} org
                                    units
                                </div>
                            </div>
                        </SelectorBarItem>
                    ...
                    <div>
                        <SelectorBarItem
                            ...
                            setOpen={() =>
                                _setPeriodVisibility((prev) => !prev)
                            }
                        >
                            <div
                                onClick={(e) => e.stopPropagation()}
            ...
            {reportStatus && <CompletenessOfReport />}
        </div>
    )
}
