  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <div className={styles.blocTabs}>
        ...
        <button
          className={toggleState === 4 ? styles.activeTabs : styles.tabs}
          onClick={() => toggleTab(4)} > Numerator Quality Parameters
        </button>
        <button
          className={toggleState === 5 ? styles.activeTabs : styles.tabs}
          onClick={() => toggleTab(5)} > Denominators
        </button>
        <button
          className={toggleState === 6 ? styles.activeTabs : styles.tabs}
          onClick={() => toggleTab(6)} > Denominator Relations
        </button>
        <button
          className={toggleState === 7 ? styles.activeTabs : styles.tabs}
